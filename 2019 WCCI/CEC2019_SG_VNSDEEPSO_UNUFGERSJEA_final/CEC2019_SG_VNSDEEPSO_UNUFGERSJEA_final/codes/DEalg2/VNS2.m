...
%% Improve initial random solution
display('HEURISTIC RULES')
display('Improve initial random solution with bound methodology and utility point of view')
% bounds methodology
...
% these heuristic rules are for the study case of the CEC/GECCO 2019 competition, if other
...
for i = 1:nper
    for j = 1:nctrl
        ...
        end                                                  % but utility can use the V2G option in the peak load periods (in this case study only?)
    end
end
...
display('search for best periods of V2G and ESS to help utility (hours in the first peak load 11-13)')
     
for V2Gperiod=1:2 %2 tuned parameter for the study case, if different case consider to tune again       
 for ESSperiod=1:5 %5 tuned parameter for the study case, if different case consider to tune again
  for BestHourToHelpUtility=11:13 % bigger probability in these hours of have the peak load
            
            V2Ginitialhour=BestHourToHelpUtility;
            ESSdischargehour=BestHourToHelpUtility;
...
display('search for best periods of V2G and ESS to help utility (hours in the second peak load 17-20)')
     
for V2Gperiod=1:2 %2 tuned parameter for the study case, if different case consider to tune again       
 for ESSperiod=2:4 %4 tuned parameter for the study case, if different case consider to tune again
  for BestHourToHelpUtility=17:20 % bigger probability in these hours of have the peak load

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%        aaaaa                                                Load MH parameters (e.g., get MH parameters from DEparameters.m file)
 switch Select_Algorithm
     case 1
        addpath('EPSOualg')
        algorithm='GM_VNPSO'; %'The participants should include their algorithm here'
        ...
        rand('state',sum(noRuns*100*clock))% ensure stochastic indpt trials
            ...
            switch Select_Algorithm
                case 1
                    ...
                    GM_VNPSO(deParameters,caseStudyData,otherParameters,lowerB,upperB);
                case 2
                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

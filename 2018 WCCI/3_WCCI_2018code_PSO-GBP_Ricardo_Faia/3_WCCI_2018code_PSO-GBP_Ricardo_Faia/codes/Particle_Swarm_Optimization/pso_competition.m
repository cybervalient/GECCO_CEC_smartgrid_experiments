...
[solFitness_M, solPenalties_M,Struct_Eval]=feval(fnc,Position,caseStudyData, otherParameters,10);
...
for it=2:MaxIt
    ...
    % Evaluation
    [solFitness_M_temp, solPenalties_M_temp,Struct_Eval_temp]=feval(fnc,Position,caseStudyData, otherParameters,10);

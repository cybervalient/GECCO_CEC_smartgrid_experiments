...
addpath('GDEalg') %Participants should add to the path the folder with the code of their algorithms 
...
algorithm='GDE_rand'; %'The participants should include their algorithm here'

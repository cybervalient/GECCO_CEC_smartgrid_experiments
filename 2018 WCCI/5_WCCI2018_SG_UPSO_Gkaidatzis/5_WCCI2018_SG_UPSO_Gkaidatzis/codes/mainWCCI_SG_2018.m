...
addpath('upsoAlg') %Participants should add to the path the folder with the code of their algorithms 
% load('last_one.mat');
...
%   
        [ResDB(iRuns).Fit_and_p,ResDB(iRuns).sol,ResDB(iRuns).fitVector,ResDB(iRuns).Best_otherInfo] = upso( deParameters,caseStudyData,otherParameters,lowerB,upperB);

...
function [Deepso,Ff,Set] = DEEPSO_SETTINGS1(low_habitat_limit,up_habitat_limit,deParameters,gbest)
...
Set.Xmax(1:round(Set.D*x))         = up_habitat_limit(1:round(Set.D*x));    % Individuals' lower bounds.
Set.Xmin(1:round(Set.D*x))         = low_habitat_limit(1:round(Set.D*x));    % Individuals' upper bounds.
